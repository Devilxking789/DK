//base by DEVIL KING (Xeon Bot Inc.)
...
title: ownername,
body: botname,
thumbnailUrl: "https://i.ibb.co/hx9dzZpN/thumb.png",
sourceUrl: link,
mediaType: 1,
...
await sleep(100)
    ...
    const carouselContent = {
        carouselMessage: {
            cards: [
                {
                    jpegThumbnail: 'https://i.ibb.co/hx9dzZpN/thumb.png',
                    carouselCard: {
                        body: "T-Яyuichi",
                        buttons: [
                            {
                        ...
                        header: {
                            imageMessage: { jpegThumbnail: 'https://i.ibb.co/hx9dzZpN/thumb.png' },
...
if (q.includes('https://devil-store.pages.dev')){
...
const optionsObf6 = {
  ...
  identifierGenerator: function () {
            ...
            const filePath = './enc_by_@Devil.js';
            ...
            await XeonBotInc.sendMessage(m.chat, {
                ...
                fileName: 'Encrypted By @Devil.js'
            }, { quoted: m });
...
const filePath = './dec_by_@devil.js';
...
"mediaUrl": 'https://i.ibb.co/hx9dzZpN/thumb.png',
...
break;
  ...
  const imageUrl = "https://i.ibb.co/hx9dzZpN/thumb.png"; // Define the single image URL
